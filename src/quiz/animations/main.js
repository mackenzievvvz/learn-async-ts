...
// }
function animateAlice10() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            if (alice10) {
                console.log("animate 10");
                return [2 /*return*/, alice10.animate(aliceTumbling1, aliceTiming1).finished];
            }
            else {
...
function animateAlice20() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!alice20) return [3 /*break*/, 2];
                    return [4 /*yield*/, animateAlice10()];
                case 1:
                    _a.sent();
                    console.log("animate 20");
                    return [2 /*return*/, alice20.animate(aliceTumbling1, aliceTiming1).finished];
                case 2: throw ("potnetially null");
            }
        });
    });
}
function animateAlice30() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!alice30) return [3 /*break*/, 2];
                    return [4 /*yield*/, animateAlice20()];
                case 1:
                    _a.sent();
                    console.log("animate 30");
                    return [2 /*return*/, alice30.animate(aliceTumbling1, aliceTiming1).finished];
                case 2: throw ("potnetially null");
            }
        });
    });
